...
@property (nonatomic, strong) id<KKColorListViewControllerDelegate> delegate;
@property (nonatomic, strong) void(^colorSelectedBlock)(KKColorListViewController *vc, KKColor *color);
