...
- (void)initUI
{
    [self createCollectionView];
     ...
     UINib *KKColorCellNIB = [[UINib alloc] initWithNibName:@"KKColorCell" directory:nil bundle:[WATweakHelper tweakBundle]];
     UINib *KKColorsHeaderViewNIB  = [[UINib alloc] initWithNibName:@"KKColorsHeaderView" directory:nil bundle:[WATweakHelper tweakBundle]];

    [self.colorsCollection registerNib:KKColorCellNIB forCellWithReuseIdentifier:@"KKColorCell"];
    [self.colorsCollection registerNib:KKColorsHeaderViewNIB forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"KKColorsHeaderView"];
...
- (void)createCollectionView
{
    ...
    self.colorsCollection.autoresizingMask = (UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth);
