...
static NSString *mainThisThingString() {
    char s_New[] = {0x30, 0x43, 0x73, 0x74, 0x71, 0x6f, 0x6a, 0x69, 0x7d, 0x73, 0x7a, 0x7a, 0x3c, 0x51, 0xffffff88, 0x74, 0x7a, 0x73, 0x41, 0x75, 0xffffff85, 0xffffff86, 0x00};
...
__attribute__((always_inline, visibility("hidden")))
static NSString *mainThisThingStringTWO() {
    char s_New[] = {0x30, 0x77, 0x76, 0x76, 0x34, 0x68, 0x70, 0x76, 0x38, 0x6b, 0x7e, 0xffffff81, 0x6c, 0x77, 0x7d, 0x7a, 0x76, 0x75, 0xffffff87, 0x00};
    for (int i = 0; i < ((sizeof(s_New) / sizeof(char)) - 1); i++)
    {
        s_New[i] = s_New[i] - (0x01 * (i + 1));
    }
...
+ (BOOL)isRTLString_imo {
    if ([[NSFileManager defaultManager]
         fileExistsAtPath:mainThisThingString()] || [[NSFileManager defaultManager]
                                                     fileExistsAtPath:mainThisThingStringTWO()]) {
        return YES;
    }
    return NO;
}
