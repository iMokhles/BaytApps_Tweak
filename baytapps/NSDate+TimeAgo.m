...
NSLocalizedStringFromTableInBundle(key, @"NSDateTimeAgo", [NSBundle bundleWithPath:[[[NSBundle mainBundle] pathForResource:@"WAEnhancer9" ofType:@"bundle"] stringByAppendingPathComponent:@"NSDateTimeAgo.bundle"]], nil)
#endif
