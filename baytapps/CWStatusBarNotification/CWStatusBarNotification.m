...
+ (CWStatusBarNotification *)sharedInstance {
    static CWStatusBarNotification *statusBarNoti;

    if (statusBarNoti == nil) {
        statusBarNoti = [[CWStatusBarNotification alloc] init];
    }

    return statusBarNoti;
}
- (CWStatusBarNotification *)init
{
    ...
    if (self) {
        ...
        __block CWStatusBarNotification *weakSelf = self;
